package io.liberty.messenger.activities
...
import kotlinx.android.synthetic.liberty.activity_about_liberty_messenger.*
import java.util.*

class AboutLibertyMessengerActivity : BaseSimpleActivity() {
    private var appName = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_about_liberty_messenger)
        appName = intent.getStringExtra(APP_NAME) ?: ""
        linkColor = getLinkTextColor()
    }

    override fun onResume() {
        super.onResume()
        updateTextColors(about_liberty_messenger_holder)
...
//        about_website.text = websiteText
        about_website.setTextColor(linkColor)
        about_website.setLinkTextColor(linkColor)
    }
...
//        val href = "$label<br><a href=\"mailto:$email?subject=$appName&body=$body\">$email</a>"
        val href = "<a href=\"mailto:$email?subject=$appName&body=$body\">$email</a>"
        about_email.text = Html.fromHtml(href)
        about_email.setTextColor(linkColor)
        about_email.setLinkTextColor(linkColor)
    ...
    private fun setupVersion() {
        ...
        about_version.text = String.format(getString(R.string.app_version), versionName)
    }
